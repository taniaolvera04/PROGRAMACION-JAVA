...
public class R extends JFrame {
	...
	public R() {
		...
		img.setBounds(10, 66, 206, 110);
		contentPane.add(img);
		ancho=img.getWidth();
		alto=img.getHeight();
		Image foto=Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/rectangulo.jpeg"));
		...
		lblb.setBounds(137, 197, 46, 14);
		contentPane.add(lblb);
		
		txtbase = new JTextField();
		txtbase.setForeground(new Color(255, 85, 255));
		txtbase.setFont(new Font("BIZ UDGothic", Font.BOLD, 13));
		txtbase.setColumns(10);
		txtbase.setBounds(235, 195, 104, 20);
		...
		JLabel lbln = new JLabel("RECTÁNGULO");
	...
	lblh.setBounds(137, 241, 46, 14);
	contentPane.add(lblh);
	
	txtaltura = new JTextField();
	txtaltura.setForeground(new Color(255, 85, 255));
	txtaltura.setFont(new Font("BIZ UDGothic", Font.BOLD, 13));
	txtaltura.setColumns(10);
	txtaltura.setBounds(235, 240, 104, 20);
