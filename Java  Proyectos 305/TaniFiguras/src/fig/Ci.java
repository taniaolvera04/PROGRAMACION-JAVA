...
public class Ci extends JFrame {
	...
	public Ci() {
		...
		ancho=img.getWidth();
		alto=img.getHeight();
		Image foto=Toolkit.getDefaultToolkit().getImage(getClass().getResource("/img/circulo.png"));
		...
		lblradio.setBounds(144, 224, 46, 14);
		contentPane.add(lblradio);
		
		txtradio = new JTextField();
		txtradio.setForeground(new Color(255, 85, 255));
		txtradio.setFont(new Font("BIZ UDGothic", Font.BOLD, 13));
		txtradio.setColumns(10);
		txtradio.setBounds(240, 222, 104, 20);
		...
		JLabel lbln = new JLabel("CÍRCULO");
