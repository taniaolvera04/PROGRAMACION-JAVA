...
AppCopyright= Copyright ® 2023-202 My empresa, CECYTEM
;WindowVisible= yes
...
OutputBaseFilename=SetupPrueba
...
UninstallDisplayName=Desinstalar Prueba
...
Source: C:\Users\PALOMO\Desktop\compilar\crear exe a partir de jar\Prue.exe; DestDir: {app}; Flags: ignoreversion
Source: C:\Users\PALOMO\Desktop\compilar\crear exe a partir de jar\*; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: C:\Users\PALOMO\Desktop\compilar\crear instalador\complementos\venta.sql*; DestDir: {tmp}; Flags : ignoreversion deleteafterinstall
...
Name: {group}\Prueba; Filename: {app}\Prue.exe; WorkingDir: {app}; IconFilename: {app}\Iconos\icono.ico; Comment: "Ejecutable"; 
Name: {commondesktop}\Prueba; Filename: {app}\Prue.exe; WorkingDir: {app}; IconFilename: {app}\Iconos\icono.ico; Comment: "Ejecutable escritorio";
...
;Filename: C:\wamp\bin\mysql\mysql5.5.24\bin\mysql.exe; Parameters: "-u root -h localhost -e ""create database venta CHARACTER SET 'utf8' COLLATE utf8_spanish_ci";  WorkingDir: {tmp}; StatusMsg: Creando la Base dedatos; Flags: runhidden
...
;Filename: C:\wamp\bin\mysql\mysql5.5.24\bin\mysql.exe; Parameters: "-u root -h localhost -e ""use venta; source venta.sql;";  WorkingDir: {tmp}; StatusMsg: Creando Tablas; Flags: runhidden
...
WelcomeLabel1=Instalación de Prueba

; Este es eñ titulo que se mostrara debajo del titulo (Cambia el Nombre_Aplicación por el nombre de tu aplicacion)
WelcomeLabel2=Este proceso instalará Prueba.%n%nSe recomienda cerrar todas las aplicaciones abiertas%nantes de continuar.
