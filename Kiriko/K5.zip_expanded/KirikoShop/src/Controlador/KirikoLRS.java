...
public int setFoliov(int foliov) {
	return this.foliov = foliov;
}
...
public boolean insertarDC() {
	if(c.insertarDetalleC(this)) {
	return true;
	}else {
		return false;
	}
...
public boolean recFC() {
	if(c.recuperarFolioc(this)) {
	return true;
	}else {
		return false;
	}
